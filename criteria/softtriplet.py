...
class Criterion(torch.nn.Module):
    def __init__(self, opt):
        ...
        ####
        self.n_centroids  = opt.loss_softtriplet_n_centroids # K 10
        # original: 10
        self.margin_delta = opt.loss_softtriplet_margin_delta # margin 0.01
        self.gamma        = opt.loss_softtriplet_gamma # 1 ./ gamma = 10
        self.lam          = opt.loss_softtriplet_lambda # la 20
        self.reg_weight   = opt.loss_softtriplet_reg_weight # tau 0.2
        ...
        self.lr   = opt.lr*opt.loss_softtriplet_lrmulti
